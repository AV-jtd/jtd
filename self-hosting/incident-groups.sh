...
#          bash /opt/jtd/self-hosting/incident-groups.sh Фамилия
#
...
set -uo pipefail
# Фамилию передавайте аргументом: репозиторий публичный, и зашивать
# в него имена сотрудников незачем.
WHO="${1:-}"
[ -n "$WHO" ] || { echo "Укажите фамилию: bash $0 Фамилия"; exit 2; }
