...
- **Наша сторона**: protocol.logo_url + sides.ours + кнопки upload/delete лого встроены в аватар (12×12, бакет `protocol-logos`).
- **Партнёр**: clients.logo_url + clients.name + бейдж CRM. Если CRM не привязан — кнопка «+ Добавить в CRM».
