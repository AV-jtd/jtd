...
- project: проект / направление / программа (напр. «Бережное томление», «Чистые составы»)
...
5. «ТМ» → brand. «Проект» / «Направление» / «Программа» → project. «Цель ввода» → purpose. «Вес, кг» → weight_kg. «Тип упаковки» → package_type. «Цена...» (без слова дата) → target_price. «Сроки годности» → shelf_life. «ШК» → barcode (если первый), второй ШК (тарный/сети) → plu. «код 1С» → sku_code_1c. «№ п/п» → external_ref. «Комментарии» → comment.
