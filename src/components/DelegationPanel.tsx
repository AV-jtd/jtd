...
import { HardHat, Plus, Trash2, Pencil, Check, X } from "lucide-react";
...
/**
 * Панель «Подрядчики» — внешние исполнители без учётной записи.
 * Управление отделами и иерархией перенесено в OrgStructurePanel.
 */
