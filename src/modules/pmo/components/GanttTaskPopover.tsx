...
export default function GanttTaskPopover({ task, project, children, onUpdate, onToggle, onDelete }: GanttTaskPopoverProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-72 p-3 space-y-2" align="start" side="bottom" sideOffset={4}>
        {/* Title */}
        ...
        {/* Complete */}
        <button
          onClick={() => { onToggle(task.id, !task.is_completed); setOpen(false); }}
