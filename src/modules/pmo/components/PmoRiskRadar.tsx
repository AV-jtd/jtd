...
const CACHE_KEY = "pmo_risk_radar_cache";
...
export default function PmoRiskRadar({ projects }: PmoRiskRadarProps) {
  ...
  const fetchRisks = useCallback(async () => {
    ...
    try {
      ...
      console.error("PMO Risk radar error:", e);
